            ...
            <div class="sb2-2">
                ...
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="lecturer"> Users(Lecturers)</a>
                        </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    <h4>Lecturers Details</h4>
                                    <p>All about Lecturers like name, student id, phone, email, country, city and more</p>
                                </div>
                                <div class="tab-inn">
